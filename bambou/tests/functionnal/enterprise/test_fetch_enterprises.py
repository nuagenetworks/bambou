...
class Fetch(TestCase):
    ...
    def test_fetch_all(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch()
    ...
    def test_fetch_all_without_commit(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(commit=False)
    ...
    def test_fetch_with_filter(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(filter=u"name == 'Enterprise 2'")
    ...
    def test_fetch_with_group_by(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(group_by=['field1', 'field2'])
    ...
    def test_fetch_with_order_by(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(order_by='name ASC')
    ...
    def test_fetch_with_page(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(page=2)
    ...
    def test_fetch_with_page_size(self):
        ...
        with patch('requests.request', mock):
            (fetcher, user, enterprises, connection) = self.user.enterprises_fetcher.fetch(page_size=10)
